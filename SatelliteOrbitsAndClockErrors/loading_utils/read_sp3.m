function [sp3, Greg_time] = read_sp3( filename )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% SP3 data columns
sp3.col.WEEK = 1;       % week
sp3.col.TOW = 2;        % time of week in seconds
sp3.col.PRN = 3;        % Satellite ID
sp3.col.X = 4;          % X coordinate [km]
sp3.col.Y = 5;          % Y coordinate [km]
sp3.col.Z = 6;          % Z coordinate [km]
sp3.col.B = 7;          % clock error [s]
